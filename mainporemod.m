...
b = 2e-3; % 2 milliseconds
conductivity = .01;
fieldzero = 1e-10;
loops = 6; % resolution in time
...
initialreturnedvalue = poremovieApril23methodmod2(start(1),width(1),1,b,loops,fieldzero,conductivity);
...
for i = 2:N
    ...
    returnedvalue = poremovieApril23methodmod2(start(i), width(i),i,b,loops,fieldzero,conductivity);
    for j = 1:loops
