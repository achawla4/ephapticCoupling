function result = mainporeAug172020(mnow,nnow,hnow,pnow,t,oldans,oldm,oldn,oldh,oldp)
...
myinitialreturnedvalue = poremovieAug17methodnew(1,fieldzero,permittivity, mnow,nnow,hnow,pnow, oldans, oldm, oldn, oldh, oldp);
mylength=31;
mylength2 = 31;
...
for i = 2:N
    ...
    myreturnedvalue = poremovieAug17methodnew(i,fieldzero,permittivity,mnow,nnow,hnow,pnow,oldans, oldm, oldn, oldh, oldp);
    j=1;
...
result{1,4} = realmin; %SummedF(1).oldsourcelowv;
