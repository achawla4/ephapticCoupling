...
function returncellarray = poremovieApril23methodnew(trialnum,b, loops,fieldzero, permittivity, mnow, nnow,hnow,pnow)
...
numchan = 10; %number of ion channels in a ring
sourcelowv = linspace(0,2*pi,numchan)% single ion channel position in ring
