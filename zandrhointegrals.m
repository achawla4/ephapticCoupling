function [Q, Q2] = zandrhointegrals(rho, phi, z)
...
% positions.
numchan = 20; %numberofionchannelsinaring = 20;
format long
lowv = 10*2*pi/numchan; % phi' lower limit
highv = 11*2*pi/numchan; % phi' upper limit
...
% Second integral
% 
lowv2 = 10*2*pi/numchan; % phi' lower limit
highv2 = 11*2*pi/numchan; % phi' upper limit
