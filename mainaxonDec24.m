...
axon = packagedCNNDec24_2016(N, d, ell, L, delT, timesteps, endlength, temperature, Ranvier_array, r0, cm, gm, cnd, gnd, rf, InjectionDuration, injectnumber1, stimpos1, delaydelta, injectnumber2, stimpos2, delaydelta2, injectnumber3, stimpos3, delaydelta3, injectnumber4, stimpos4, Eonoff, Estrength, K3_1);
Timespent = toc
LTminus1 = timesteps;
...
temp1 = axon(1).V(40, 1:LTminus1) > .1;
...
temp2 = axon(1).V(60, 1:LTminus1) > .1;
